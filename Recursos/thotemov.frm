...
Private Sub bo712_Click()
    ...
    cn.Execute ("delete from hotelguiad where idfactura=" & Val("" & txidfacturax.Fields("idfactura")))
    txidfacturax.Delete
    Command1_Click
...
Sub filtro()
    ...
    If opcion1 = "1" Then  'producto
        If Len(Text1) = 0 Then
            cad = "select Descripcio,Tipo,Tipodoc from tipo where tipodoc='" & vtipo & "'"

        End If

        If Len(Text1) > 0 Then
            cad = "select Descripcio,Tipo,Tipodoc from tipo where tipodoc='" & vtipo & "' AND   " & Combo2 & " like '" & Text1.Text & "%'"
...
Sub ejecuta(sw As Integer)
    ...
    If Len(buffer) = 0 Then
        cad = "SELECT * from hotelguia  "

    End If

    If Len(buffer) > 0 Then
        cad = "SELECT *  from hotelguia   where idecheckin=" & Val(idxcheckin) & " and " & Combo1 & " like '" & buffer & "%'"
...
Sub carga_tmp()
    ...
    mytablex.Open "select * from hotelguiad where idfactura=" & Val(idfactura), cn, adOpenStatic, adLockOptimistic
    Do
...
Sub graba_detalle()
    ...
    cn.Execute ("delete from hotelguiad where idfactura=" & Val("" & txidfacturax.Fields("idfactura")))
    mytabley.Open "select * from hotelguiad where idfactura=" & Val("" & txidfacturax.Fields("idfactura")), cn, adOpenStatic, adLockOptimistic
    ir_inicio
    Do
