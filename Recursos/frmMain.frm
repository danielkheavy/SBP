...
Private Sub LoadNewDoc()
    ...
    frmD.Caption = globaldir & "\" & gusuario & ".txt"
    sfile = globaldir & "\" & gusuario & ".txt"
    frmD.rtfText.LoadFile sfile
    frmD.Caption = sfile
    frmD.Show
...
Private Sub mnuHelpAbout_Click()
    MsgBox "Visualizador de Archivos", 48, "Aviso"
End Sub
