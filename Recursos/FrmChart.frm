...
Begin VB.Form FrmChart 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSChart20Lib.MSChart msChart1 
         Height          =   7455
         Left            =   120
         OleObjectBlob   =   "FrmChart.frx":0F5C
         TabIndex        =   9
         Top             =   360
         Width           =   11055
      End
...
Private Sub CmdSaveas_Click()
    ...
    With CommonDialog1
        .Filter = "Pictures (*.bmp)|*.bmp" ' You can lso Save the Pic in JPG/GIF/TIFF
        .DefaultExt = "bmp"
        .CancelError = False
        .ShowSave
...
Private Sub Command2_Click()
    ...
    If Combo1 = "Documentos" Or Combo1 = "Clientes" Or Combo1 = "Vendedor" Then
        If Combo2 = "Tipo" Then
            buf = "select Tipo as mes,moneda," & swbuf & " from " & cambuf & " where "
            buf2 = "Tipo"

        End If

        If Combo2 = "Usuario" Then
            buf = "select Usuario as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "Usuario"

        End If

        If Combo2 = "Bodega" Then
            buf = "select Bodega as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "Bodega"

        End If

        If Combo2 = "Caja" Then
            buf = "select Caja as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "Caja"

        End If

        If Combo2 = "Codigo" Then
            buf = "select Codigo as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "Codigo"

        End If
   
        If Combo2 = "Vendedor" Then
            buf = "select Vendedor as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "Vendedor"

        End If

        If Combo2 = "Anual" Then
            buf = "select year(fecha) as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "year(fecha)"

        End If

        If Combo2 = "Mensual" Then
            buf = "select month(fecha) as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "month(fecha)"

        End If

        If Combo2 = "Semanal" Then
            buf = "select DATENAME(weekday,fecha) as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "DATENAME(weekday,fecha)"

        End If

        If Combo2 = "Diario" Then
            buf = "select day(fecha) as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = "day(fecha)"

        End If

        If Combo2 = "Horario" Then
            buf = "select left(hora,2) as mes,moneda," & swbuf & "  from " & cambuf & " where "
            buf2 = " left(hora,2) "
        ...
        If servicio <> "%" Then
            buf = buf & " and servicio like '" & servicio & "'"
    ...
    If Combo1 = "Productos" Then
        ...
        '--------------
        If Combo2 = "Tipo" Then
            buf = "select Tipo as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Tipo"

        End If

        If Combo2 = "Usuario" Then
            buf = "select Usuario as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Usuario"

        End If

        If Combo2 = "Codigo" Then
            buf = "select Codigo as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Codigo"

        End If

        If Combo2 = "Bodega" Then
            buf = "select Bodega as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Bodega"

        End If

        If Combo2 = "Caja" Then
            buf = "select Caja as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Caja"
        ...
        If Combo2 = "Vendedor" Then
            buf = "select Vendedor as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "Vendedor"

        End If

        If Combo2 = "Anual" Then
            buf = "select year(fecha) as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "year(fecha)"

        End If

        If Combo2 = "Mensual" Then
            buf = "select month(fecha) as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "month(fecha)"

        End If

        If Combo2 = "Semanal" Then
            buf = "select weekday(fecha) as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "weekday(fecha)"

        End If

        If Combo2 = "Diario" Then
            buf = "select day(fecha) as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = "day(fecha)"

        End If

        If Combo2 = "Horario" Then
            buf = "select left(hora,2) as mes,moneda," & swbuf & "  from " & dambuf & " where "
            buf2 = " left(hora,2)"
        ...
        If servicio <> "%" Then
            buf = buf & " and servicio like '" & moneda & "'"
