...
Begin VB.Form txpoclie 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Tabla de Tipos de Clientes"
   ClientHeight    =   10080
   ClientLeft      =   165
   ClientTop       =   -615
   ClientWidth     =   15120
...
Private Sub bo712_Click()
    ...
    If MsgBox("Desea Borra " + txempre.Fields("tipoclie"), 1, "Aviso") <> 1 Then
        Exit Sub
...
Private Sub tipoclie_KeyPress(KeyAscii As Integer)
    ...
    If Len(tipoclie) = 0 Then Exit Sub
    descripcio.SetFocus
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        If Len(buffer) = 0 Then
            cad = "SELECT * from tipoclie    "

        End If

        If Len(buffer) > 0 Then
            cad = "SELECT *  from tipoclie   where  " & Combo1 & " like '" & buffer & "%'"
...
Private Sub dbgrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        ...
        'tipoclie = dbGrid1.Columns(1)
        'Frame1.Visible = False
        'Frame1.Enabled = False
        'tipoclie.SetFocus
        'tipoclie_KeyPress 13
    End If
...
Sub grabando()
    txempre.Fields("tipoclie") = Trim(tipoclie)
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        ...
        rbusca.Open "select tipoclie from tipoclie where tipoclie='" & tipoclie & "'", cn, adOpenStatic, adLockOptimistic

        If rbusca.RecordCount > 0 Then
            rbusca.Close
            MsgBox "Ya existe tipoclie ", 48, "Aviso"
            Exit Function
