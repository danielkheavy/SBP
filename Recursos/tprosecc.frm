...
Begin VB.Form tprosecc 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Tabla de Secciones de Produccion"
   ClientHeight    =   10080
   ClientLeft      =   165
   ClientTop       =   -615
   ClientWidth     =   15120
...
Private Sub bo712_Click()
    ...
    If MsgBox("Desea Borra " + txempre.Fields("seccion"), 1, "Aviso") <> 1 Then
        Exit Sub
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        ...
        If Len(buffer) > 0 Then
            cad = "SELECT *  from pseccion   where  " & Combo1 & " like '" & buffer & "%'"
...
Sub pone_registro()
    seccion = Trim("" & txempre.Fields("seccion"))
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        ...
        rbusca.Open "select seccion from pseccion where seccion='" & seccion & "'", cn, adOpenStatic, adLockOptimistic
        ...
        txempre.AddNew
        txempre.Fields("seccion") = seccion
        grabando
        txempre.Update
        dlo132_Click
        Exit Function
