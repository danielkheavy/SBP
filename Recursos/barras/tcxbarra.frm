...
Begin VB.Form tcxbarra 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "tcxbarra.frx":0D4A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "tcxbarra.frx":124C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "tcxbarra.frx":174E
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnuView 
      ...
      Begin VB.Menu mnuViewCenterLines 
         Caption         =   "Lineas Centradas"
      End
      Begin VB.Menu mnuView1 
         Caption         =   "-"
      End
      Begin VB.Menu mnuViewSizeLabel 
         Caption         =   "Display Tamaño Etiqueta"
         Checked         =   -1  'True
      End
   End
...
Private Sub Label_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    'move barlines
    tcxbarra.BarTopLine.Visible = True
    tcxbarra.BarLeftLine.Visible = True
    tcxbarra.BarTopLine.X1 = X
    tcxbarra.BarTopLine.X2 = X
    tcxbarra.BarTopLine.Y1 = 0
    tcxbarra.BarTopLine.Y2 = BarTop.Height
    tcxbarra.BarLeftLine.X1 = 0
    tcxbarra.BarLeftLine.X2 = BarLeft.Width
    tcxbarra.BarLeftLine.Y1 = Y
    tcxbarra.BarLeftLine.Y2 = Y
...
Private Sub ObjectImage_MouseDown(Index As Integer, _
                                  Button As Integer, _
                                  Shift As Integer, _
                                  X As Single, _
                                  Y As Single)
...
Private Sub ObjectImage_MouseUp(Index As Integer, _
                                Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
...
Private Sub ObjectShape_MouseDown(Index As Integer, _
                                  Button As Integer, _
                                  Shift As Integer, _
                                  X As Single, _
                                  Y As Single)
...
Private Sub ObjectShape_MouseUp(Index As Integer, _
                                Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
...
Private Sub ObjectText_MouseDown(Index As Integer, _
                                 Button As Integer, _
                                 Shift As Integer, _
                                 X As Single, _
                                 Y As Single)
...
Private Sub ObjectText_MouseMove(Index As Integer, _
                                 Button As Integer, _
                                 Shift As Integer, _
                                 X As Single, _
                                 Y As Single)
...
Private Sub ObjectText_MouseUp(Index As Integer, _
                               Button As Integer, _
                               Shift As Integer, _
                               X As Single, _
                               Y As Single)
...
Private Sub WorkBar_MouseMove(Button As Integer, _
                              Shift As Integer, _
                              X As Single, _
                              Y As Single)
