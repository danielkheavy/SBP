...
Begin VB.Form docguia 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "docguia.frx":0000
         Height          =   7815
         Left            =   120
         OleObjectBlob   =   "docguia.frx":0014
         TabIndex        =   48
         TabStop         =   0   'False
         Top             =   600
         Width           =   13335
   ...
   Begin VB.Frame Frame5 
      ...
      Begin MSDBGrid.DBGrid DBGrid4 
         Height          =   3255
         Left            =   120
         OleObjectBlob   =   "docguia.frx":1BF1
         TabIndex        =   46
         Top             =   240
         Width           =   7215
      End
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "docguia.frx":2C54
         Height          =   3975
         Left            =   120
         OleObjectBlob   =   "docguia.frx":2C68
         TabIndex        =   30
         Top             =   960
         Width           =   11655
      End
