...
'http://support.microsoft.com/default.aspx?scid=kb;en-us;182 070
'187562 - HOWTO Resize the Controls in SSTab When Form is Resized
'http://support.microsoft.com/default.aspx?scid=kb;EN-US;187 562
'
...
Private Sub Resize_For_Resolution(ByVal SFX As Single, _
    ...
    With MyForm
        ...
        For I = 0 To .count - 1
            ...
            If TypeName(.Controls(I)) <> "CommonDialog" And TypeName(.Controls(I)) <> "Menu" And TypeName(.Controls(I)) <> "Timer" And TypeName(.Controls(I)) <> "Winsock" And TypeName(.Controls(I)) <> "ImageList" Then
