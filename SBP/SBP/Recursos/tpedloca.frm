...
Begin VB.Form tpedloca 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Pedidos Automaticos Locales"
   ClientHeight    =   9000
   ClientLeft      =   150
   ClientTop       =   540
   ClientWidth     =   14265
   ...
   Begin VB.Frame Frame5 
      ...
      Begin MSDBGrid.DBGrid DBGrid4 
         Height          =   3255
         Left            =   120
         OleObjectBlob   =   "tpedloca.frx":1212
         TabIndex        =   43
         Top             =   240
         Width           =   7215
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Label Label15 
         ...
         Caption         =   "Nota. Los campos que no tienen local nose graban"
         Height          =   495
         Left            =   120
         TabIndex        =   48
         Top             =   4080
      ...
      Begin VB.Label Label6 
         BackColor       =   &H00C0FFFF&
         BorderStyle     =   1  'Fixed Single
         Caption         =   "Solo se generan los pedidos de Locales que existan en la base de datos"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   0
   ...
   Begin VB.Frame Frame2 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Pedidos a Local de Compras"
      Height          =   8055
      Left            =   0
      TabIndex        =   1
      Top             =   690
      ...
      Begin MSDBGrid.DBGrid DBGrid2 
         Bindings        =   "tpedloca.frx":6807
         Height          =   7215
         Left            =   120
         OleObjectBlob   =   "tpedloca.frx":681B
         TabIndex        =   0
         Top             =   240
         Width           =   13935
      End
...
Private Sub cmdSave_Click()
    ...
    If found = 0 Then
        MsgBox "No existe tipo documento " & tipo, 48, "Aviso"
        Exit Sub
...
Sub graba_detalle(xnumero As String)
    ...
    mytablez.Open "select * from drequisa ", cn, adOpenStatic, adLockOptimistic
    mytablez.AddNew
...
Sub proceso_pedido_automatico()
    ...
    If Check1.Value = 0 Then
        buf = "select producto.unidad,producto.factor,producto.costou ,producto.igv ,Producto.descripcio,Producto.producto,producto.marca,producto.unidad as Und1,producto.Factor as F,Producto.Costou as Precio,producto.monedac as M,producto.familia,producto.Subfamilia,codprov.codigo from codprov left join producto on codprov.producto=producto.producto where codprov.codigo='" & proveedor & "'"

    End If

    If Check1.Value = 1 Then
        buf = "select producto.unidad,producto.factor,producto.costou ,producto.igv ,Producto.descripcio,Producto.producto,producto.marca,producto.unidad as Und1,producto.Factor as F,Producto.Costou as Precio,producto.monedac as M,producto.familia,producto.Subfamilia from producto   "
    ...
    Do
        ...
        xminimo = 0
        xsaldo = busca_saldo("" & mysnapx.Fields("producto"), xminimo)
        sw = 0
...
am1:
        ...
        Else
            mytabley.Fields("proveedor") = local2
...
Function busca_saldo(buf As String, yminimo As Double) As Double
...
Sub graba_cabecera(xnumero As String)
    ...
    mytablex.Open "select * from crequisa where local='" & local1 & "' and tipo='" & tipo & "' and serie='" & serie & "' and numero='" & Numero & "'", cn, adOpenStatic, adLockOptimistic
