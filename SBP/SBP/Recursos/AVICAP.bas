...
Declare Function SendMessageS _
        Lib "user32" _
        Alias "SendMessageA" (ByVal hwnd As Long, _
                              ByVal wMsg As Long, _
                              ByVal wParam As Integer, _
...
Declare Function capCreateCaptureWindowA _
...
Declare Function capGetDriverDescriptionA _
        Lib "avicap32.dll" (ByVal wDriver As Integer, _
...
Function capDriverGetName(ByVal lwnd As Long, _
...
Function capDriverGetVersion(ByVal lwnd As Long, _
                             ByVal szVer As Long, _
                             ByVal wSize As Integer) As Boolean
    capDriverGetVersion = SendMessage(lwnd, WM_CAP_DRIVER_GET_VERSION, wSize, szVer)

End Function

Function capDriverGetCaps(ByVal lwnd As Long, _
                          ByVal s As Long, _
                          ByVal wSize As Integer) As Boolean
...
Function capFileGetCaptureFile(ByVal lwnd As Long, _
                               ByVal szName As Long, _
...
Function capSetAudioFormat(ByVal lwnd As Long, _
                           ByVal s As Long, _
                           ByVal wSize As Integer) As Boolean
...
Function capGetAudioFormat(ByVal lwnd As Long, _
                           ByVal s As Long, _
...
Function capGetVideoFormat(ByVal lwnd As Long, _
                           ByVal s As Long, _
                           ByVal wSize As Integer) As Long
...
Function capSetVideoFormat(ByVal lwnd As Long, _
                           ByVal s As Long, _
                           ByVal wSize As Integer) As Boolean
...
Function capGetStatus(ByVal lwnd As Long, _
                      ByVal s As Long, _
                      ByVal wSize As Integer) As Boolean
...
Function capCaptureGetSetup(ByVal lwnd As Long, _
                            ByVal s As Long, _
                            ByVal wSize As Integer) As Boolean
...
Function capCaptureSetSetup(ByVal lwnd As Long, _
                            ByVal s As Long, _
                            ByVal wSize As Integer) As Boolean
...
Function capGetMCIDeviceName(ByVal lwnd As Long, _
                             ByVal szName As Long, _
                             ByVal wSize As Integer) As Boolean
...
Function capPaletteAuto(ByVal lwnd As Long, _
                        ByVal iFrames As Integer, _
                        ByVal iColor As Long) As Boolean
    capPaletteAuto = SendMessage(lwnd, WM_CAP_PAL_AUTOCREATE, iFrames, iColors)

End Function

Function capPaletteManual(ByVal lwnd As Long, _
                          ByVal fGrab As Boolean, _
                          ByVal iColors As Long) As Boolean
