...
Private Sub bo712_Click()
    ...
    If MsgBox("Desea Borra " + txempre.Fields("clasifica"), 1, "Aviso") <> 1 Then
        Exit Sub
...
Private Sub clasificaca_Change()
...
Private Sub clasifica_KeyPress(KeyAscii As Integer)
    ...
    If Len(clasifica) = 0 Then Exit Sub
    descripcio.SetFocus
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        If Len(buffer) = 0 Then
            cad = "SELECT * from clasifi    "

        End If

        If Len(buffer) > 0 Then
            cad = "SELECT *  from clasifi   where  " & Combo1 & " like '" & buffer & "%'"
...
Private Sub dbgrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        ...
        'clasifica = dbGrid1.Columns(1)
        'Frame1.Visible = False
        'Frame1.Enabled = False
        'clasifica.SetFocus
        'clasifica_KeyPress 13
    End If
...
Sub grabando()
    txempre.Fields("clasifica") = Trim(clasifica)
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        If Len(clasifica) = 0 Then
            clasifica.SetFocus
            Exit Function

        End If

        rbusca.Open "select clasifica from clasifi where clasifica='" & clasifica & "'", cn, adOpenStatic, adLockOptimistic

        If rbusca.RecordCount > 0 Then
            rbusca.Close
            MsgBox "Ya existe clasifica ", 48, "Aviso"
            Exit Function
