...
Begin VB.Form FrmTipoOperacion 
   BackColor       =   &H00FFFFC0&
   Caption         =   "Tabla de Operacion"
   ClientHeight    =   9045
   ClientLeft      =   165
   ClientTop       =   15
   ClientWidth     =   12525
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdCerrar 
         ...
         Height          =   1020
         Left            =   8400
         Picture         =   "FrmTipoOperacion.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdGuardar 
         ...
         Height          =   975
         Left            =   8400
         Picture         =   "FrmTipoOperacion.frx":08CA
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   2160
         Width           =   1470
      ...
      Begin VB.Label Label4 
         ...
         Caption         =   "P Productiva I Improductiva  E Estructural"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Left            =   720
         MaskColor       =   &H00E0E0E0&
         Picture         =   "FrmTipoOperacion.frx":1194
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton cmdDelete 
         ...
         Left            =   1440
         MaskColor       =   &H00E0E0E0&
         Picture         =   "FrmTipoOperacion.frx":23A6
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Left            =   2760
         MaskColor       =   &H00E0E0E0&
         Picture         =   "FrmTipoOperacion.frx":35B8
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Salir"
         Top             =   0
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Left            =   2160
         MaskColor       =   &H00E0E0E0&
         Picture         =   "FrmTipoOperacion.frx":47CA
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton cmdAddEntry 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "FrmTipoOperacion.frx":59DC
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "FrmTipoOperacion"
...
buf = txempre.Fields("operacion")
If Frame2.Visible = True Then
   dbGrid1.SetFocus
   Exit Sub
End If
If MsgBox("Desea Borra " + txempre.Fields("operacion"), 1, "Aviso") <> 1 Then
   Exit Sub
End If
txempre.Delete
Command1_Click
...
reporgen.NAMETABLA = "tbloperacion"
reporgen.Show 1
...
If opcion1 = "1" Then  'bodega
   If Len(buffer) = 0 Then
      cad = "SELECT * from tbloperacion    "
   End If
   If Len(buffer) > 0 Then
      cad = "SELECT *  from tbloperacion   where  " & Combo1 & " like '" & buffer & "%'"
   End If
...
End If
If KeyCode = 13 Then
   'tbloperacion = dbGrid1.Columns(1)
   'Frame1.Visible = False
   'Frame1.Enabled = False
   'tbloperacion.SetFocus
   'tbloperacion_KeyPress 13
End If
End Sub
...
operacion = Trim("" & txempre.Fields("operacion"))
descripcio = Trim("" & txempre.Fields("descripcio"))
End Sub
Sub grabando()
txempre.Fields("tipo") = Trim(tipo)
txempre.Fields("operacion") = Trim(operacion)
...
If Frame2.Caption = "Nuevo" Then
   If Len(operacion) = 0 Then
      operacion.SetFocus
      Exit Function
   End If
   rbusca.Open "select operacion from tbloperacion where operacion='" & operacion & "'", cn, adOpenStatic, adLockOptimistic
   If rbusca.RecordCount > 0 Then
      rbusca.Close
      MsgBox "Ya existe tbloperacion ", 48, "Aviso"
      Exit Function
   End If
   txempre.AddNew
   txempre.Fields("operacion") = operacion
   grabando
   txempre.Update
   dlo132_Click
   Exit Function
...
Dim mytablex As New ADODB.Recordset
   mytablex.Open "select * from archivo where menu='tbloperacion' and   estado='S'", cn, adOpenStatic, adLockOptimistic
...
buf = mnuArchivoArray(Index).Caption
   mytablex.Open "select * from archivo where menu='tbloperacion' and descripcio='" & Trim(buf) & "'", cn, adOpenStatic, adLockOptimistic
   If mytablex.RecordCount = 0 Then
      mytablex.Close
   End If
   'busca el reporte
...
If KeyAscii = 27 Then
   ...
   Exit Sub
End If
If Len(operacion) = 0 Then Exit Sub
descripcio.SetFocus
