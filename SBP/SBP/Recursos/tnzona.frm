...
Private Sub bo712_Click()
    ...
    If MsgBox("Desea Borra " + txempre.Fields("zona"), 1, "Aviso") <> 1 Then
        Exit Sub
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        ...
        If Len(buffer) > 0 Then
            cad = "SELECT *  from zona   where  " & Combo1 & " like '" & buffer & "%'"
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        ...
        rbusca.Open "select zona from zona where zona='" & zona & "'", cn, adOpenStatic, adLockOptimistic

        If rbusca.RecordCount > 0 Then
            rbusca.Close
            MsgBox "Ya existe zona ", 48, "Aviso"
            Exit Function
