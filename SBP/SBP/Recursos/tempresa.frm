...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        If Len(buffer) = 0 Then
            cad = "SELECT * from empresa    "

        End If

        If Len(buffer) > 0 Then
            cad = "SELECT *  from empresa   where  " & Combo1 & " like '" & buffer & "%'"
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        ...
        rbusca.Open "select codigo from empresa where codigo='" & codigo & "'", cn, adOpenStatic, adLockOptimistic
