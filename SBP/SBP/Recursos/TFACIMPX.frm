...
Begin VB.Form tfacimpx 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "TFACIMPX.frx":0000
         Height          =   7935
         Left            =   120
         OleObjectBlob   =   "TFACIMPX.frx":0014
         TabIndex        =   197
         TabStop         =   0   'False
         Top             =   960
         Width           =   14535
      ...
      Begin MSDBGrid.DBGrid DBGrid3 
         Bindings        =   "TFACIMPX.frx":09DF
         Height          =   7815
         Left            =   120
         OleObjectBlob   =   "TFACIMPX.frx":09F3
         TabIndex        =   198
         Top             =   960
         Visible         =   0   'False
         Width           =   14415
   ...
   Begin VB.Frame Frame5 
      ...
      Begin MSDBGrid.DBGrid DBGrid4 
         Height          =   3255
         Left            =   120
         OleObjectBlob   =   "TFACIMPX.frx":A452
         TabIndex        =   141
         Top             =   240
         Width           =   7215
      End
   ...
   Begin MSDBGrid.DBGrid DBGrid2 
      Bindings        =   "TFACIMPX.frx":1428F
      Height          =   5415
      Left            =   0
      OleObjectBlob   =   "TFACIMPX.frx":142A3
      TabIndex        =   17
      TabStop         =   0   'False
      Top             =   2400
      Width           =   14775
...
mytablex.Fields("gasto") = gasto
mytablex.Fields("tipoimp") = tipoimp
mytablex.Fields("serieimp") = serieimp
mytablex.Fields("numeroimp") = numeroimp
...
If KeyAscii <> 13 Then Exit Sub
If Len(gasto) = 0 Then
   MsgBox "No existe el tipo de gasto ", 48, "Aviso"
   gasto.SetFocus
   Exit Sub
End If
found = busca_gasto("" & gasto)
If found = 0 Then
   MsgBox "No existe el tipo de gasto ", 48, "Aviso"
   gasto.SetFocus
   Exit Sub
...
Private Sub gasto_KeyUp(KeyCode As Integer, Shift As Integer)
If KeyCode = &H26 Then
   dias.SetFocus
   Exit Sub
End If
...
Set mytableb = mydbxglo.OpenTable("detalle")
mytableb.Index = "tdetalle"
End If
'MsgBox dgusuariog
...
If racu = "Z" Then
denuevo0:
mytableb.Seek "=", local1, "TE", serie, numero
If Not mytableb.NoMatch Then
   mytableb.Delete
   GoTo denuevo0
End If
denuevo01:
mytableb.Seek "=", "", "TS", serie, numero
If Not mytableb.NoMatch Then
   mytableb.Delete
   GoTo denuevo01
End If
...
End If
If found = 3 Then
   'descarga_saldo mytableb, mytabley, local1, "TS", serie, numero, 0, mytablea, mytablex
   'descarga_saldo mytableb, mytabley, "", "TE", serie, numero, 0, mytablea, mytablex 'mytablea productos
End If
 ...
 'End If
   ...
   If "" & mytablex.Fields("local") = xlocal And "" & mytablex.Fields("tipo") = xtipo And "" & mytablex.Fields("serie") = xserie And "" & mytablex.Fields("numero") = xnumero Then
      ...
      If "" & mytablex.Fields("acu") = "J" Or "" & mytablex.Fields("acu") = "K" Or "" & mytablex.Fields("acu") = "L" Or "" & mytablex.Fields("acu") = "M" Then 'compras varia el precios y costo
         graba_costos mytablex, mytablea, mytabley
      End If
...
Loop
End Sub
Sub graba_costos(mytablex As Table, mytabley As Table, mytablexx As Table)
...
End If
If Len(gasto) = 0 Then
   MsgBox "No existe gasto ", 48, "Aviso"
   gasto.SetFocus
   Exit Function
End If
found = busca_gasto("" & gasto)
...
dbgrid2.columns(6) = 0
dbgrid2.columns(9) = 0
dbgrid2.columns(8) = Val("" & mytablex.Fields("flete"))
...
End If
   ...
   If "" & mytablex.Fields("local") = "" & local1 And "" & mytablex.Fields("tipo") = "" & ttipo And "" & mytablex.Fields("serie") = "" & serie And "" & mytablex.Fields("numero") = "" & numero Then
         ...
         Data2.Recordset.Fields("localf") = ""
         Data2.Recordset.Fields("bodegaf") = ""
...
End Function
Function busca_gasto(buf As String)
Dim mytablex As Table
Set mytablex = mydbxglo.OpenTable("aduanaga")
mytablex.Index = "aduanaga"
mytablex.Seek "=", buf
If Not mytablex.NoMatch Then
   busca_gasto = 1
End If
