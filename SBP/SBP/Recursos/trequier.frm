...
Begin VB.Form trequier 
   BackColor       =   &H00FFFFC0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pedidos de Almacenes"
   ClientHeight    =   9930
   ClientLeft      =   45
   ClientTop       =   615
   ClientWidth     =   14955
...
mytablex.Close
End Function
Sub descarga_saldo(xlocal As String, xtipo As String, xserie As String, xnumero As String, sw As Integer, tipoarch As String, xtipo1 As String)
Dim sdx As Double
Dim signo As Double
Dim sww As Integer
...
Exit Sub
End Sub
Function verificar_recibo(buf As String, xlocal As String, xtipo As String, xserie As String, xnumero As String)
Dim mytablex As New ADODB.Recordset
...
Next r
    ...
    objExcel.ActiveSheet.Cells(v, h + 6) = "Soles"
