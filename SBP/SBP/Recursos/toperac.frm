...
Begin VB.Form Toperac
   BackColor       =   &H00FFFF00&
   Caption         =   "Tabla de Secciones Produccion"
   ClientHeight    =   6675
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   11400
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDBGrid.DBGrid DBGrid1 
         Bindings        =   "prosecci.frx":0000
         Height          =   5295
         Left            =   120
         OleObjectBlob   =   "prosecci.frx":0014
         TabIndex        =   15
         TabStop         =   0   'False
         Top             =   1080
         Width           =   11055
...
Set mytablex = mydbx.OpenTable("pseccion")
mytablex.Index = "pseccion"
