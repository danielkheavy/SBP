...
Sub prueba_reporte()
    ...
    'Call Reporter(CrystalReport1, globalpath & "\001d\06\reporte\toperacoesproducto.rpt", "")
End Sub
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        If Len(buffer) = 0 Then
            cad = "SELECT * from toperaco    "

        End If

        If Len(buffer) > 0 Then
            cad = "SELECT *  from toperaco   where  " & Combo1 & " like '" & buffer & "%'"
...
Private Sub dbgrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        ...
        'toperaco = dbGrid1.Columns(1)
        'Frame1.Visible = False
        'Frame1.Enabled = False
        'toperaco.SetFocus
        'toperaco_KeyPress 13
    End If
...
Function grabar()
    ...
    If Frame2.Caption = "Nuevo" Then
        ...
        rbusca.Open "select operacion from toperaco where operacion='" & operacion & "'", cn, adOpenStatic, adLockOptimistic

        If rbusca.RecordCount > 0 Then
            rbusca.Close
            MsgBox "Ya existe toperaco ", 48, "Aviso"
            Exit Function
...
Sub agregar_menus()
    ...
    mytablex.Open "select * from archivo where menu='toperaco' and   estado='S'", cn, adOpenStatic, adLockOptimistic
...
Sub mnuarchivoarray_click(Index As Integer)
    ...
    mytablex.Open "select * from archivo where menu='toperaco' and descripcio='" & Trim(buf) & "'", cn, adOpenStatic, adLockOptimistic
