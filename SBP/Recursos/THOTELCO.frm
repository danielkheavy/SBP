...
Private Sub bo712_Click()
    ...
    buf = "" & txbdco.Fields("hotelconsumo")
    ...
    If MsgBox("Desea Borra " + "" & txbdco.Fields("hotelconsumo"), 1, "Aviso") <> 1 Then
        Exit Sub
...
Sub prueba_reporte()
    ...
    'Call Reporter(CrystalReport1, globalpath & "\001d\06\reporte\hotelconsumoesproducto.rpt", "")
End Sub

Private Sub hotelconsumo_KeyPress(KeyAscii As Integer)
    ...
    If Len(hotelconsumo) = 0 Then Exit Sub
    descripcio.SetFocus
...
Sub ejecuta(sw As Integer)
    ...
    If opcion1 = "1" Then  'bodega
        If Len(buffer) = 0 Then
            cad = "SELECT * from hotelconsumo  where idecheckin=  " & Val(idcheckin) & ""

        End If

        If Len(buffer) > 0 Then
            cad = "SELECT *  from hotelconsumo   where idecheckin=" & Val(idcheckin) & " and  " & Combo1 & " like '" & buffer & "%'"
...
Private Sub dbgrid1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = 13 Then
        ...
        'hotelconsumo = dbGrid1.Columns(1)
        'Frame1.Visible = False
        'Frame1.Enabled = False
        'hotelconsumo.SetFocus
        'hotelconsumo_KeyPress 13
    End If
...
Sub pone_registro()
    hotelconsumo = Trim("" & txbdco.Fields("hotelconsumo"))
...
Sub grabando()
    'txbdco.Fields("hotelconsumo") = Trim(hotelconsumo)
...
Sub agregar_menus()
    ...
    mytablex.Open "select * from archivo where menu='hotelconsumo' and   estado='S'", cn, adOpenStatic, adLockOptimistic
...
Sub mnuarchivoarray_click(Index As Integer)
    ...
    mytablex.Open "select * from archivo where menu='hotelconsumo' and descripcio='" & Trim(buf) & "'", cn, adOpenStatic, adLockOptimistic
